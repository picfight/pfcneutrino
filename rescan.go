...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*pfcutil.Block, error)
...
func WatchAddrs(watchAddrs ...pfcutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *waddrmgr.BlockStamp) ([]*pfcutil.Tx, error) {
	...
	relevantTxs := make([]*pfcutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *pfcutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *pfcutil.Tx) (bool, error) {
...
// replacement for the pfcd rescan and notification functionality used in
...
func AddAddrs(addrs ...pfcutil.Address) UpdateOption {
