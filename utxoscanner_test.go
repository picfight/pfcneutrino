...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*pfcutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, pfcutil.NewBlock(&Block100000))
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, pfcutil.NewBlock(&Block99999))
...
// The following is taken from the picfight/pfcutil project.
