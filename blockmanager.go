...
import (
	...
	"github.com/picfight/pfcneutrino/chainsync"
	"github.com/picfight/pfcneutrino/headerfs"
	"github.com/picfight/pfcneutrino/headerlist"
...
// newBlockManager returns a new picfightcoin block manager.  Use Start to begin
...
func (b *blockManager) checkHeaderSanity(blockHeader *wire.BlockHeader,
	...
	stubBlock := pfcutil.NewBlock(&wire.MsgBlock{
		Header: *blockHeader,
	})
