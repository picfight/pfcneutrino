...
// fully fledged database for Picfightcoin block headers. The blockHeaderStore
...
// BlockHeader is a Picfightcoin block header that also has its height included.
...
// standard Picfightcoin algorithm to compute block locators are employed.
func (h *blockHeaderStore) BlockLocatorFromHash(hash *chainhash.Hash) (
	blockchain.BlockLocator, error) {
